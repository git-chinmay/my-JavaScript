...
1) Model Detects the pattern drwan on tKinter GUI and passsed to CNN 
2) CNN comapres it with mnist dataset which is a collection of millions handwritten numbers
3) If pattren matches with any mnist pattern with high probability then model consider it as that number
4) Then this number passed to tkinter for the calucation function as per user seelction.

Modules needed :- Keras,Tensorflow,tkinter,pandas and numpy
"""
